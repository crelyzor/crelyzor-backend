...
export const getTeam = async (_req: Request, res: Response) => {
  ...
  return apiResponse(res, { statusCode: 200, message: "Team fetched", data: { admins } });
};
...
export const invite = async (req: Request, res: Response) => {
  ...
  const result = await sendInvite(parsed.data.email, parsed.data.name, req.adminId!);
  return apiResponse(res, { statusCode: 201, message: "Invite sent", data: result });
};

export const checkInvite = async (req: Request, res: Response) => {
  const { token } = req.params;
  const result = await validateInviteToken(token);
  return apiResponse(res, { statusCode: 200, message: "Invite valid", data: result });
};
...
export const acceptInviteHandler = async (req: Request, res: Response) => {
  ...
  return apiResponse(res, { statusCode: 200, message: "Invite accepted", data: result });
};
...
export const getUsers = async (req: Request, res: Response) => {
  ...
  const result = await listUsers(parsed.data.page, parsed.data.limit, parsed.data.search);
  return apiResponse(res, { statusCode: 200, message: "Users fetched", data: result });
};

export const getUser = async (req: Request, res: Response) => {
  const { id } = req.params;
  const result = await getUserDetail(id);
  return apiResponse(res, { statusCode: 200, message: "User fetched", data: result });
};
...
export const updatePlan = async (req: Request, res: Response) => {
  ...
  return apiResponse(res, { statusCode: 200, message: "User plan updated", data: updated });
};

export const resetUsage = async (req: Request, res: Response) => {
  const { id } = req.params;
  const usage = await resetUserUsage(id);
  return apiResponse(res, { statusCode: 200, message: "User usage reset", data: usage });
};

export const getStats = async (req: Request, res: Response) => {
  const stats = await getPlatformStats();
  return apiResponse(res, { statusCode: 200, message: "Platform stats fetched", data: stats });
};
